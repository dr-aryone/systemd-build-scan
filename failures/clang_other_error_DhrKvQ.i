...
# 141 "./src/systemd/sd-bus-vtable.h"
struct __useless_struct_to_allow_trailing_semicolon__;
...
# 468 "./src/basic/macro.h"
static inline _Bool UID_IS_INVALID(uid_t uid) {
...
static inline _Bool GID_IS_INVALID(gid_t gid) {
        return gid == (gid_t) ((uint32_t) -1) || gid == (gid_t) ((uint16_t) -1);
}
# 490 "./src/basic/macro.h"
# 1 "./src/basic/log.h" 1
# 27 "./src/basic/log.h"
...
# 512 "./src/basic/missing.h"
static inline pid_t gettid(void) {
        return (pid_t) syscall(186);
}
# 977 "./src/basic/missing.h"
...
# 185 "./src/basic/util.h"
static inline int safe_atolu(const char *s, unsigned long *ret_u) {
#pragma GCC diagnostic push
# 186 "./src/basic/util.h"
;
# 186 "./src/basic/util.h"
...
# 290 "./src/basic/util.h"
ssize_t string_table_lookup(const char * const *table, size_t len, const char *key);
# 340 "./src/basic/util.h"
...
static inline void CPU_FREEp(cpu_set_t* *p) { if (*p) __sched_cpufree (*p); } struct __useless_struct_to_allow_trailing_semicolon__;
...
static inline _Bool __attribute__ ((pure)) in_charset(const char *s, const char* charset) {
        do { if ((__builtin_expect(!!(!(s)),0))) log_assert_failed("s", "./src/basic/util.h", 440, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(charset)),0))) log_assert_failed("charset", "./src/basic/util.h", 441, __PRETTY_FUNCTION__); } while (0);
...
static inline int negative_errno(void) {
        ...
        do { if (!(((__builtin_expect(!!((*__errno_location ()) > 0),1))) ? (1) : (log_assert_failed_return("(*__errno_location ()) > 0", "./src/basic/util.h", 668, __PRETTY_FUNCTION__), 0))) return (-22); } while (0);
...
static inline unsigned log2i(int x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/basic/util.h", 703, __PRETTY_FUNCTION__); } while (0);

        return 4 * 8 - __builtin_clz(x) - 1;
}

static inline unsigned log2u(unsigned x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/basic/util.h", 709, __PRETTY_FUNCTION__); } while (0);

        return sizeof(unsigned) * 8 - __builtin_clz(x) - 1;
}

static inline unsigned log2u_round_up(unsigned x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/basic/util.h", 715, __PRETTY_FUNCTION__); } while (0);
...
static inline void qsort_safe(void *base, size_t nmemb, size_t size, comparison_fn_t compar) {
        ...
        do { if ((__builtin_expect(!!(!(base)),0))) log_assert_failed("base", "./src/basic/util.h", 792, __PRETTY_FUNCTION__); } while (0);
...
static inline void *memmem_safe(const void *haystack, size_t haystacklen, const void *needle, size_t needlelen) {
        ...
        do { if ((__builtin_expect(!!(!(haystack)),0))) log_assert_failed("haystack", "./src/basic/util.h", 805, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(needle)),0))) log_assert_failed("needle", "./src/basic/util.h", 806, __PRETTY_FUNCTION__); } while (0);
...
int getxattr_malloc(const char *path, const char *name, char **value, _Bool allow_symlink);
...
static inline _Bool strv_fnmatch_or_empty(char* const* patterns, const char *s, int flags) {
        do { if ((__builtin_expect(!!(!(s)),0))) log_assert_failed("s", "./src/basic/strv.h", 153, __PRETTY_FUNCTION__); } while (0);
...
static inline void sd_bus_flush_close_unrefp(sd_bus* *p) { if (*p) sd_bus_flush_close_unref(*p); } struct __useless_struct_to_allow_trailing_semicolon__;
...
# 80 "./src/libsystemd/sd-bus/bus-common-errors.h"
...
# 1 "./src/basic/hostname-util.h" 1
# 28 "./src/basic/hostname-util.h"
_Bool hostname_is_set(void);

char* gethostname_malloc(void);

_Bool hostname_is_valid(const char *s, _Bool allow_trailing_dot) __attribute__ ((pure));
char* hostname_cleanup(char *s);



_Bool is_localhost(const char *hostname);
_Bool is_gateway_hostname(const char *hostname);

int sethostname_idempotent(const char *s);

int read_hostname_config(const char *path, char **hostname);
# 39 "src/import/importd.c" 2
...
static int transfer_new(Manager *m, Transfer **ret) {
        ...
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 153, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(ret)),0))) log_assert_failed("ret", "src/import/importd.c", 154, __PRETTY_FUNCTION__); } while (0);
...
static void transfer_send_log_line(Transfer *t, const char *line) {
        ...
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 195, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(line)),0))) log_assert_failed("line", "src/import/importd.c", 196, __PRETTY_FUNCTION__); } while (0);

        syslog_parse_priority(&line, &priority, 1);

        ({ int _level = (priority), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 200, __func__, "(transfer%" "u" ") %s", t->id, line) : -abs(_e); });
        ...
        r = sd_bus_emit_signal(
                        ...
                        line);
        if (r < 0)
                ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 211, __func__, "Cannot emit message: %m") : -abs(_e); });
 }

static void transfer_send_logs(Transfer *t, _Bool flush) {
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 215, __PRETTY_FUNCTION__); } while (0);
        ...
        while (t->log_message_size > 0) {
                ...
                if (!n) {
                        log_oom_internal("src/import/importd.c", 258, __func__);
                        continue;
                }
...
static int transfer_finalize(Transfer *t, _Bool success) {
        ...
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 272, __PRETTY_FUNCTION__); } while (0);
        ...
        if (r < 0)
                ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 288, __func__, "Cannot emit message: %m") : -abs(_e); });
...
static int transfer_cancel(Transfer *t) {
        ...
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 297, __PRETTY_FUNCTION__); } while (0);
...
static int transfer_on_pid(sd_event_source *s, const siginfo_t *si, void *userdata) {
        ...
        do { if ((__builtin_expect(!!(!(s)),0))) log_assert_failed("s", "src/import/importd.c", 311, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 312, __PRETTY_FUNCTION__); } while (0);

        if (si->si_code == CLD_EXITED) {
                if (si->_sifields._sigchld.si_status != 0)
                        ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 316, __func__, "Import process failed with exit code %i.", si->_sifields._sigchld.si_status) : -abs(_e); });
                else {
                        ({ int _level = (7), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 318, __func__, "Import process succeeded.") : -abs(_e); });
                        success = 1;
                }
                ...
                ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 325, __func__, "Import process terminated by signal %s.", signal_to_string(si->_sifields._sigchld.si_status)) : -abs(_e); });
        else
                ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 327, __func__, "Import process failed due to unknown reason.") : -abs(_e); });
...
static int transfer_on_log(sd_event_source *s, int fd, uint32_t revents, void *userdata) {
        ...
        do { if ((__builtin_expect(!!(!(s)),0))) log_assert_failed("s", "src/import/importd.c", 338, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 339, __PRETTY_FUNCTION__); } while (0);
        ...
        if (l <= 0) {
                ...
                if (l < 0)
                        ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 348, __func__, "Failed to read log message: %m") : -abs(_e); });
...
static int transfer_start(Transfer *t) {
        ...
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 365, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(t->pid <= 0)),0))) log_assert_failed("t->pid <= 0", "src/import/importd.c", 366, __PRETTY_FUNCTION__); } while (0);
        ...
        if (t->pid == 0) {
                ...
                do { if ((__builtin_expect(!!(!(prctl(1, 15) == 0)),0))) log_assert_failed("prctl(PR_SET_PDEATHSIG, SIGTERM) == 0", "src/import/importd.c", 396, __PRETTY_FUNCTION__); } while (0);

                pipefd[0] = safe_close(pipefd[0]);

                if (dup2(pipefd[1], 2) != 2) {
                        ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 401, __func__, "Failed to dup2() fd: %m") : -abs(_e); });
                        _exit(1);
                }

                if (t->stdout_fd >= 0) {
                        if (dup2(t->stdout_fd, 1) != 1) {
                                ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 407, __func__, "Failed to dup2() fd: %m") : -abs(_e); });
                                _exit(1);
                        }
                        ...
                        if (dup2(pipefd[1], 1) != 1) {
                                ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 415, __func__, "Failed to dup2() fd: %m") : -abs(_e); });
                                _exit(1);
                        }
                }
                ...
                if (t->stdin_fd >= 0) {
                        if (dup2(t->stdin_fd, 0) != 0) {
                                ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 425, __func__, "Failed to dup2() fd: %m") : -abs(_e); });
                                _exit(1);
                        }
                        ...
                        if (null_fd < 0) {
                                ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 436, __func__, "Failed to open /dev/null: %m") : -abs(_e); });
                                _exit(1);
                        }

                        if (dup2(null_fd, 0) != 0) {
                                ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 441, __func__, "Failed to dup2() fd: %m") : -abs(_e); });
                                _exit(1);
                        }
                ...
                if (({ static const typeof(TRANSFER_IMPORT_TAR) _array[] = { (TRANSFER_IMPORT_TAR), TRANSFER_IMPORT_RAW }; const typeof(TRANSFER_IMPORT_TAR) _x = (t->type); unsigned _i; _Bool _found = 0; for (_i = 0; _i < (sizeof(_array)/sizeof((_array)[0])); _i++) if (_array[_i] == _x) { _found = 1; break; } _found; }))
                        cmd[k++] = "/usr/lib/systemd/systemd-import";
                else if (({ static const typeof(TRANSFER_EXPORT_TAR) _array[] = { (TRANSFER_EXPORT_TAR), TRANSFER_EXPORT_RAW }; const typeof(TRANSFER_EXPORT_TAR) _x = (t->type); unsigned _i; _Bool _found = 0; for (_i = 0; _i < (sizeof(_array)/sizeof((_array)[0])); _i++) if (_array[_i] == _x) { _found = 1; break; } _found; }))
                        cmd[k++] = "/usr/lib/systemd/systemd-export";
                else
                        cmd[k++] = SYSTEMD_PULL_PATH;

                if (({ static const typeof(TRANSFER_IMPORT_TAR) _array[] = { (TRANSFER_IMPORT_TAR), TRANSFER_EXPORT_TAR, TRANSFER_PULL_TAR }; const typeof(TRANSFER_IMPORT_TAR) _x = (t->type); unsigned _i; _Bool _found = 0; for (_i = 0; _i < (sizeof(_array)/sizeof((_array)[0])); _i++) if (_array[_i] == _x) { _found = 1; break; } _found; }))
                        cmd[k++] = "tar";
                else if (({ static const typeof(TRANSFER_IMPORT_RAW) _array[] = { (TRANSFER_IMPORT_RAW), TRANSFER_EXPORT_RAW, TRANSFER_PULL_RAW }; const typeof(TRANSFER_IMPORT_RAW) _x = (t->type); unsigned _i; _Bool _found = 0; for (_i = 0; _i < (sizeof(_array)/sizeof((_array)[0])); _i++) if (_array[_i] == _x) { _found = 1; break; } _found; }))
                        cmd[k++] = "raw";
                else
                        cmd[k++] = "dkr";
                ...
                if (!({ static const typeof(TRANSFER_EXPORT_TAR) _array[] = { (TRANSFER_EXPORT_TAR), TRANSFER_EXPORT_RAW }; const typeof(TRANSFER_EXPORT_TAR) _x = (t->type); unsigned _i; _Bool _found = 0; for (_i = 0; _i < (sizeof(_array)/sizeof((_array)[0])); _i++) if (_array[_i] == _x) { _found = 1; break; } _found; })) {
                        if (t->remote)
                                cmd[k++] = t->remote;
                        else
                                cmd[k++] = "-";
                ...
                ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 502, __func__, "Failed to execute %s tool: %m", cmd[0]) : -abs(_e); });
                _exit(1);
        }
...
static int manager_on_notify(sd_event_source *s, int fd, uint32_t revents, void *userdata) {
        ...
        for ((cmsg) = ((size_t) (&msghdr)->msg_controllen >= sizeof (struct cmsghdr) ? (struct cmsghdr *) (&msghdr)->msg_control : (struct cmsghdr *) 0); (cmsg); (cmsg) = __cmsg_nxthdr ((&msghdr), (cmsg))) {
                if (cmsg->cmsg_level == 1 && cmsg->cmsg_type == SCM_CREDENTIALS && cmsg->cmsg_len == ((((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (sizeof(struct ucred))))

                        ucred = (struct ucred*) ((cmsg)->__cmsg_data);
        }

        if (msghdr.msg_flags & MSG_TRUNC) {
                ({ int _level = (4), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 609, __func__, "Got overly long notification datagram, ignoring.") : -abs(_e); });
                return 0;
        }

        if (!ucred || ucred->pid <= 0) {
                ({ int _level = (4), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 614, __func__, "Got notification datagram lacking credential information, ignoring.") : -abs(_e); });
                return 0;
        }
        ...
        if (!t) {
                ({ int _level = (4), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 623, __func__, "Got notification datagram from unexpected peer, ignoring.") : -abs(_e); });
                return 0;
        }
        ...
        *e = 0;
        ...
        if (r < 0 || percent > 100) {
                ({ int _level = (4), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 643, __func__, "Got invalid percent value, ignoring.") : -abs(_e); });
                return 0;
        }

        t->progress_percent = percent;

        ({ int _level = (7), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 649, __func__, "Got percentage from client: %u%%", percent) : -abs(_e); });
        return 0;
}
...
static int manager_new(Manager **ret) {
        ...
        do { if ((__builtin_expect(!!(!(ret)),0))) log_assert_failed("ret", "src/import/importd.c", 662, __PRETTY_FUNCTION__); } while (0);
...
static Transfer *manager_find(Manager *m, TransferType type, const char *dkr_index_url, const char *remote) {
        ...
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 705, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(type >= 0)),0))) log_assert_failed("type >= 0", "src/import/importd.c", 706, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(type < _TRANSFER_TYPE_MAX)),0))) log_assert_failed("type < _TRANSFER_TYPE_MAX", "src/import/importd.c", 707, __PRETTY_FUNCTION__); } while (0);
...
static int method_import_tar_or_raw(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 728, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 729, __PRETTY_FUNCTION__); } while (0);
...
static int method_export_tar_or_raw(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 793, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 794, __PRETTY_FUNCTION__); } while (0);
...
static int method_pull_tar_or_raw(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 859, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 860, __PRETTY_FUNCTION__); } while (0);
...
static int method_list_transfers(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 1039, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1040, __PRETTY_FUNCTION__); } while (0);
...
static int method_cancel(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 1076, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 1077, __PRETTY_FUNCTION__); } while (0);
...
static int method_cancel_transfer(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 1106, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1107, __PRETTY_FUNCTION__); } while (0);
...
static int property_get_progress(
        ...
        do { if ((__builtin_expect(!!(!(bus)),0))) log_assert_failed("bus", "src/import/importd.c", 1151, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(reply)),0))) log_assert_failed("reply", "src/import/importd.c", 1152, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 1153, __PRETTY_FUNCTION__); } while (0);

        return sd_bus_message_append(reply, "d", (double) t->progress_percent / 100.0);
}

static int property_get_type(sd_bus *bus, const char *path, const char *interface, const char *property, sd_bus_message *reply, void *userdata, sd_bus_error *error) { const char *value; TransferType *field = userdata; int r; do { if ((__builtin_expect(!!(!(bus)),0))) log_assert_failed("bus", "src/import/importd.c", 1158, __PRETTY_FUNCTION__); } while (0); do { if ((__builtin_expect(!!(!(reply)),0))) log_assert_failed("reply", "src/import/importd.c", 1158, __PRETTY_FUNCTION__); } while (0); do { if ((__builtin_expect(!!(!(field)),0))) log_assert_failed("field", "src/import/importd.c", 1158, __PRETTY_FUNCTION__); } while (0); value = strempty( transfer_type_to_string(*field)); r = sd_bus_message_append_basic(reply, 's', value); if (r < 0) return r; return 1; } struct __useless_struct_to_allow_trailing_semicolon__;
static int property_get_verify(sd_bus *bus, const char *path, const char *interface, const char *property, sd_bus_message *reply, void *userdata, sd_bus_error *error) { const char *value; ImportVerify *field = userdata; int r; do { if ((__builtin_expect(!!(!(bus)),0))) log_assert_failed("bus", "src/import/importd.c", 1159, __PRETTY_FUNCTION__); } while (0); do { if ((__builtin_expect(!!(!(reply)),0))) log_assert_failed("reply", "src/import/importd.c", 1159, __PRETTY_FUNCTION__); } while (0); do { if ((__builtin_expect(!!(!(field)),0))) log_assert_failed("field", "src/import/importd.c", 1159, __PRETTY_FUNCTION__); } while (0); value = strempty( import_verify_to_string(*field)); r = sd_bus_message_append_basic(reply, 's', value); if (r < 0) return r; return 1; } struct __useless_struct_to_allow_trailing_semicolon__;
...
static const sd_bus_vtable transfer_vtable[] = {
        ...
        { .type = _SD_BUS_VTABLE_METHOD, .flags = SD_BUS_VTABLE_UNPRIVILEGED, .x.method.member = "Cancel", .x.method.signature = ((void*)0), .x.method.result = ((void*)0), .x.method.handler = method_cancel, .x.method.offset = 0, },
...
static const sd_bus_vtable manager_vtable[] = {
        { .type = _SD_BUS_VTABLE_START, .flags = 0, .x.start.element_size = sizeof(sd_bus_vtable), },
        { .type = _SD_BUS_VTABLE_METHOD, .flags = SD_BUS_VTABLE_UNPRIVILEGED, .x.method.member = "ImportTar", .x.method.signature = "hsbb", .x.method.result = "uo", .x.method.handler = method_import_tar_or_raw, .x.method.offset = 0, },
        { .type = _SD_BUS_VTABLE_METHOD, .flags = SD_BUS_VTABLE_UNPRIVILEGED, .x.method.member = "ImportRaw", .x.method.signature = "hsbb", .x.method.result = "uo", .x.method.handler = method_import_tar_or_raw, .x.method.offset = 0, },
        { .type = _SD_BUS_VTABLE_METHOD, .flags = SD_BUS_VTABLE_UNPRIVILEGED, .x.method.member = "ExportTar", .x.method.signature = "shs", .x.method.result = "uo", .x.method.handler = method_export_tar_or_raw, .x.method.offset = 0, },
        { .type = _SD_BUS_VTABLE_METHOD, .flags = SD_BUS_VTABLE_UNPRIVILEGED, .x.method.member = "ExportRaw", .x.method.signature = "shs", .x.method.result = "uo", .x.method.handler = method_export_tar_or_raw, .x.method.offset = 0, },
        { .type = _SD_BUS_VTABLE_METHOD, .flags = SD_BUS_VTABLE_UNPRIVILEGED, .x.method.member = "PullTar", .x.method.signature = "sssb", .x.method.result = "uo", .x.method.handler = method_pull_tar_or_raw, .x.method.offset = 0, },
        { .type = _SD_BUS_VTABLE_METHOD, .flags = SD_BUS_VTABLE_UNPRIVILEGED, .x.method.member = "PullRaw", .x.method.signature = "sssb", .x.method.result = "uo", .x.method.handler = method_pull_tar_or_raw, .x.method.offset = 0, },
        { .type = _SD_BUS_VTABLE_METHOD, .flags = SD_BUS_VTABLE_UNPRIVILEGED, .x.method.member = "PullDkr", .x.method.signature = "sssssb", .x.method.result = "uo", .x.method.handler = method_pull_dkr, .x.method.offset = 0, },
        { .type = _SD_BUS_VTABLE_METHOD, .flags = SD_BUS_VTABLE_UNPRIVILEGED, .x.method.member = "ListTransfers", .x.method.signature = ((void*)0), .x.method.result = "a(usssdo)", .x.method.handler = method_list_transfers, .x.method.offset = 0, },
        { .type = _SD_BUS_VTABLE_METHOD, .flags = SD_BUS_VTABLE_UNPRIVILEGED, .x.method.member = "CancelTransfer", .x.method.signature = "u", .x.method.result = ((void*)0), .x.method.handler = method_cancel_transfer, .x.method.offset = 0, },
...
static int transfer_object_find(sd_bus *bus, const char *path, const char *interface, void *userdata, void **found, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(bus)),0))) log_assert_failed("bus", "src/import/importd.c", 1197, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(path)),0))) log_assert_failed("path", "src/import/importd.c", 1198, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(interface)),0))) log_assert_failed("interface", "src/import/importd.c", 1199, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(found)),0))) log_assert_failed("found", "src/import/importd.c", 1200, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1201, __PRETTY_FUNCTION__); } while (0);
...
static int manager_add_bus_objects(Manager *m) {
        ...
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1248, __PRETTY_FUNCTION__); } while (0);

        r = sd_bus_add_object_vtable(m->bus, ((void*)0), "/org/freedesktop/import1", "org.freedesktop.import1.Manager", manager_vtable, m);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1252, __func__, "Failed to register object: %m") : -abs(_e); });
        ...
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1256, __func__, "Failed to register object: %m") : -abs(_e); });

        r = sd_bus_add_node_enumerator(m->bus, ((void*)0), "/org/freedesktop/import1/transfer", transfer_node_enumerator, m);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1260, __func__, "Failed to add transfer enumerator: %m") : -abs(_e); });

        r = sd_bus_request_name(m->bus, "org.freedesktop.import1", 0);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1264, __func__, "Failed to register name: %m") : -abs(_e); });

        r = sd_bus_attach_event(m->bus, m->event, 0);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1268, __func__, "Failed to attach bus to event loop: %m") : -abs(_e); });
...
static int manager_run(Manager *m) {
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1280, __PRETTY_FUNCTION__); } while (0);
...
int main(int argc, char *argv[]) {
        ...
        if (argc != 1) {
                ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1302, __func__, "This program takes no arguments.") : -abs(_e); });
                r = -22;
                goto finish;
        }

        do { if ((__builtin_expect(!!(!(sigprocmask_many(0, ((void*)0), 17, -1) >= 0)),0))) log_assert_failed("sigprocmask_many(SIG_BLOCK, NULL, SIGCHLD, -1) >= 0", "src/import/importd.c", 1307, __PRETTY_FUNCTION__); } while (0);

        r = manager_new(&m);
        if (r < 0) {
                ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1311, __func__, "Failed to allocate manager object: %m") : -abs(_e); });
                goto finish;
        }
        ...
        r = manager_run(m);
        if (r < 0) {
                ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1321, __func__, "Failed to run event loop: %m") : -abs(_e); });
                goto finish;
        }
