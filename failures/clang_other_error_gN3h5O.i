...
int copy_bytes(int fdf, int fdt, uint64_t max_bytes, _Bool try_reflink);
...
int pull_find_old_etags(
        ...
        do { if ((__builtin_expect(!!(!(url)),0))) log_assert_failed("url", "src/import/pull-common.c", 51, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(etags)),0))) log_assert_failed("etags", "src/import/pull-common.c", 52, __PRETTY_FUNCTION__); } while (0);
...
int pull_make_local_copy(const char *final, const char *image_root, const char *local, _Bool force_local) {
        ...
        do { if ((__builtin_expect(!!(!(final)),0))) log_assert_failed("final", "src/import/pull-common.c", 128, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(local)),0))) log_assert_failed("local", "src/import/pull-common.c", 129, __PRETTY_FUNCTION__); } while (0);

        if (!image_root)
                image_root = "/var/lib/machines";

        p = ({ const char *_appendees_[] = { image_root, "/", local }; char *_d_, *_p_; int _len_ = 0; unsigned _i_; for (_i_ = 0; _i_ < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_appendees_), typeof(&*(_appendees_))), sizeof(_appendees_)/sizeof((_appendees_)[0]), (void)0)) && _appendees_[_i_]; _i_++) _len_ += strlen(_appendees_[_i_]); _p_ = _d_ = __builtin_alloca (_len_ + 1); for (_i_ = 0; _i_ < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_appendees_), typeof(&*(_appendees_))), sizeof(_appendees_)/sizeof((_appendees_)[0]), (void)0)) && _appendees_[_i_]; _i_++) _p_ = stpcpy(_p_, _appendees_[_i_]); *_p_ = 0; _d_; });
        ...
        if (r == -25) {
                ...
                if (r < 0)
                        return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 143, __func__, "Failed to copy image: %m") : -abs(_e); });
        } else if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 145, __func__, "Failed to create local image: %m") : -abs(_e); });

        ({ int _level = (6), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 147, __func__, "Created new local image '%s'.", local) : -abs(_e); });
...
int pull_make_path(const char *url, const char *etag, const char *image_root, const char *prefix, const char *suffix, char **ret) {
        ...
        do { if ((__builtin_expect(!!(!(url)),0))) log_assert_failed("url", "src/import/pull-common.c", 156, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(ret)),0))) log_assert_failed("ret", "src/import/pull-common.c", 157, __PRETTY_FUNCTION__); } while (0);
...
int pull_make_settings_job(
        ...
        __attribute__((cleanup(freep))) char *last_component = ((void*)0), *ll = ((void*)0), *settings_url = ((void*)0);
        __attribute__((cleanup(pull_job_unrefp))) PullJob *job = ((void*)0);
        const char *q;
        int r;

        do { if ((__builtin_expect(!!(!(ret)),0))) log_assert_failed("ret", "src/import/pull-common.c", 195, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(url)),0))) log_assert_failed("url", "src/import/pull-common.c", 196, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(glue)),0))) log_assert_failed("glue", "src/import/pull-common.c", 197, __PRETTY_FUNCTION__); } while (0);
        ...
        q = ({ const char *_appendees_[] = { ll, ".nspawn" }; char *_d_, *_p_; int _len_ = 0; unsigned _i_; for (_i_ = 0; _i_ < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_appendees_), typeof(&*(_appendees_))), sizeof(_appendees_)/sizeof((_appendees_)[0]), (void)0)) && _appendees_[_i_]; _i_++) _len_ += strlen(_appendees_[_i_]); _p_ = _d_ = __builtin_alloca (_len_ + 1); for (_i_ = 0; _i_ < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_appendees_), typeof(&*(_appendees_))), sizeof(_appendees_)/sizeof((_appendees_)[0]), (void)0)) && _appendees_[_i_]; _i_++) _p_ = stpcpy(_p_, _appendees_[_i_]); *_p_ = 0; _d_; });
...
int pull_make_verification_jobs(
        ...
        do { if ((__builtin_expect(!!(!(ret_checksum_job)),0))) log_assert_failed("ret_checksum_job", "src/import/pull-common.c", 238, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(ret_signature_job)),0))) log_assert_failed("ret_signature_job", "src/import/pull-common.c", 239, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(verify >= 0)),0))) log_assert_failed("verify >= 0", "src/import/pull-common.c", 240, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(verify < _IMPORT_VERIFY_MAX)),0))) log_assert_failed("verify < _IMPORT_VERIFY_MAX", "src/import/pull-common.c", 241, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(url)),0))) log_assert_failed("url", "src/import/pull-common.c", 242, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(glue)),0))) log_assert_failed("glue", "src/import/pull-common.c", 243, __PRETTY_FUNCTION__); } while (0);
...
int pull_verify(PullJob *main_job,
        ...
        do { if ((__builtin_expect(!!(!(main_job)),0))) log_assert_failed("main_job", "src/import/pull-common.c", 299, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(main_job->state == PULL_JOB_DONE)),0))) log_assert_failed("main_job->state == PULL_JOB_DONE", "src/import/pull-common.c", 300, __PRETTY_FUNCTION__); } while (0);

        if (!checksum_job)
                return 0;

        do { if ((__builtin_expect(!!(!(main_job->calc_checksum)),0))) log_assert_failed("main_job->calc_checksum", "src/import/pull-common.c", 305, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(main_job->checksum)),0))) log_assert_failed("main_job->checksum", "src/import/pull-common.c", 306, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(checksum_job->state == PULL_JOB_DONE)),0))) log_assert_failed("checksum_job->state == PULL_JOB_DONE", "src/import/pull-common.c", 307, __PRETTY_FUNCTION__); } while (0);

        if (!checksum_job->payload || checksum_job->payload_size <= 0) {
                ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 310, __func__, "Checksum is empty, cannot verify.") : -abs(_e); });
                return -74;
        }

        r = import_url_last_component(main_job->url, &fn);
        if (r < 0)
                return log_oom_internal("src/import/pull-common.c", 316, __func__);

        if (!filename_is_valid(fn)) {
                ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 319, __func__, "Cannot verify checksum, could not determine valid server-side file name.") : -abs(_e); });
                return -74;
        }

        line = ({ const char *_appendees_[] = { main_job->checksum, " *", fn, "\n" }; char *_d_, *_p_; int _len_ = 0; unsigned _i_; for (_i_ = 0; _i_ < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_appendees_), typeof(&*(_appendees_))), sizeof(_appendees_)/sizeof((_appendees_)[0]), (void)0)) && _appendees_[_i_]; _i_++) _len_ += strlen(_appendees_[_i_]); _p_ = _d_ = __builtin_alloca (_len_ + 1); for (_i_ = 0; _i_ < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_appendees_), typeof(&*(_appendees_))), sizeof(_appendees_)/sizeof((_appendees_)[0]), (void)0)) && _appendees_[_i_]; _i_++) _p_ = stpcpy(_p_, _appendees_[_i_]); *_p_ = 0; _d_; });
        ...
        if (!p || (p != (char*) checksum_job->payload && p[-1] != '\n')) {
                ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 331, __func__, "DOWNLOAD INVALID: Checksum did not check out, payload has been tampered with.") : -abs(_e); });
                return -74;
        }

        ({ int _level = (6), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 335, __func__, "SHA256 checksum of %s is valid.", main_job->url) : -abs(_e); });

        do { if ((__builtin_expect(!!(!(!settings_job || settings_job->state == PULL_JOB_DONE)),0))) log_assert_failed("!settings_job || settings_job->state == PULL_JOB_DONE", "src/import/pull-common.c", 337, __PRETTY_FUNCTION__); } while (0);

        if (settings_job &&
            settings_job->error == 0 &&
            !settings_job->etag_exists) {

                __attribute__((cleanup(freep))) char *settings_fn = ((void*)0);

                do { if ((__builtin_expect(!!(!(settings_job->calc_checksum)),0))) log_assert_failed("settings_job->calc_checksum", "src/import/pull-common.c", 345, __PRETTY_FUNCTION__); } while (0);
                do { if ((__builtin_expect(!!(!(settings_job->checksum)),0))) log_assert_failed("settings_job->checksum", "src/import/pull-common.c", 346, __PRETTY_FUNCTION__); } while (0);

                r = import_url_last_component(settings_job->url, &settings_fn);
                if (r < 0)
                        return log_oom_internal("src/import/pull-common.c", 350, __func__);

                if (!filename_is_valid(settings_fn)) {
                        ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 353, __func__, "Cannot verify checksum, could not determine server-side settings file name.") : -abs(_e); });
                        return -74;
                }

                line = ({ const char *_appendees_[] = { settings_job->checksum, " *", settings_fn, "\n" }; char *_d_, *_p_; int _len_ = 0; unsigned _i_; for (_i_ = 0; _i_ < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_appendees_), typeof(&*(_appendees_))), sizeof(_appendees_)/sizeof((_appendees_)[0]), (void)0)) && _appendees_[_i_]; _i_++) _len_ += strlen(_appendees_[_i_]); _p_ = _d_ = __builtin_alloca (_len_ + 1); for (_i_ = 0; _i_ < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_appendees_), typeof(&*(_appendees_))), sizeof(_appendees_)/sizeof((_appendees_)[0]), (void)0)) && _appendees_[_i_]; _i_++) _p_ = stpcpy(_p_, _appendees_[_i_]); *_p_ = 0; _d_; });
                ...
                if (!p || (p != (char*) checksum_job->payload && p[-1] != '\n')) {
                        ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 365, __func__, "DOWNLOAD INVALID: Checksum of settings file did not checkout, settings file has been tampered with.") : -abs(_e); });
                        return -74;
                }

                ({ int _level = (6), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 369, __func__, "SHA256 checksum of %s is valid.", settings_job->url) : -abs(_e); });
        }

        if (!signature_job)
                return 0;

        do { if ((__builtin_expect(!!(!(signature_job->state == PULL_JOB_DONE)),0))) log_assert_failed("signature_job->state == PULL_JOB_DONE", "src/import/pull-common.c", 375, __PRETTY_FUNCTION__); } while (0);

        if (!signature_job->payload || signature_job->payload_size <= 0) {
                ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 378, __func__, "Signature is empty, cannot verify.") : -abs(_e); });
                return -74;
        }

        r = pipe2(gpg_pipe, 02000000);
        if (r < 0)
                return ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 384, __func__, "Failed to create pipe for gpg: %m") : -abs(_e); });

        sig_file = mkostemp(sig_file_path, 02);
        if (sig_file < 0)
                return ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 388, __func__, "Failed to create temporary file: %m") : -abs(_e); });

        r = loop_write(sig_file, signature_job->payload, signature_job->payload_size, 0);
        if (r < 0) {
                ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 392, __func__, "Failed to write to temporary file: %m") : -abs(_e); });
                goto finish;
        }

        if (!mkdtemp(gpg_home)) {
                r = ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 397, __func__, "Failed to create tempory home for gpg: %m") : -abs(_e); });
                goto finish;
        }
        ...
        pid = fork();
        if (pid < 0)
                return ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 405, __func__, "Failed to fork off gpg: %m") : -abs(_e); });
        if (pid == 0) {
                const char *cmd[] = {
                        "gpg",
                        "--no-options",
                ...
                unsigned k = __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(cmd), typeof(&*(cmd))), sizeof(cmd)/sizeof((cmd)[0]), (void)0)) - 6;
                int null_fd;
                ...
                do { if ((__builtin_expect(!!(!(prctl(1, 15) == 0)),0))) log_assert_failed("prctl(PR_SET_PDEATHSIG, SIGTERM) == 0", "src/import/pull-common.c", 429, __PRETTY_FUNCTION__); } while (0);

                gpg_pipe[1] = safe_close(gpg_pipe[1]);

                if (dup2(gpg_pipe[0], 0) != 0) {
                        ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 434, __func__, "Failed to dup2() fd: %m") : -abs(_e); });
                        _exit(1);
                }
                ...
                if (null_fd < 0) {
                        ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 443, __func__, "Failed to open /dev/null: %m") : -abs(_e); });
                        _exit(1);
                }

                if (dup2(null_fd, 1) != 1) {
                        ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 448, __func__, "Failed to dup2() fd: %m") : -abs(_e); });
                        _exit(1);
                }
                ...
                cmd[k++] = ({ const char *_appendees_[] = { "--homedir=", gpg_home }; char *_d_, *_p_; int _len_ = 0; unsigned _i_; for (_i_ = 0; _i_ < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_appendees_), typeof(&*(_appendees_))), sizeof(_appendees_)/sizeof((_appendees_)[0]), (void)0)) && _appendees_[_i_]; _i_++) _len_ += strlen(_appendees_[_i_]); _p_ = _d_ = __builtin_alloca (_len_ + 1); for (_i_ = 0; _i_ < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_appendees_), typeof(&*(_appendees_))), sizeof(_appendees_)/sizeof((_appendees_)[0]), (void)0)) && _appendees_[_i_]; _i_++) _p_ = stpcpy(_p_, _appendees_[_i_]); *_p_ = 0; _d_; });
                ...
                ({ int _level = (3), _e = ((*__errno_location ())); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 476, __func__, "Failed to execute gpg: %m") : -abs(_e); });
                _exit(1);
        }
        ...
        if (r < 0) {
                ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 484, __func__, "Failed to write to pipe: %m") : -abs(_e); });
                goto finish;
        }
        ...
        if (r < 0)
                goto finish;
        if (r > 0) {
                ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 495, __func__, "DOWNLOAD INVALID: Signature verification failed.") : -abs(_e); });
                r = -74;
        } else {
                ({ int _level = (6), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/pull-common.c", 498, __func__, "Signature verification succeeded.") : -abs(_e); });
                r = 0;
        }
