...
# 140 "./src/systemd/sd-bus-vtable.h"
struct __useless_struct_to_allow_trailing_semicolon__;
...
# 179 "./src/basic/util.h"
static inline int safe_atolu(const char *s, unsigned long *ret_u) {
#pragma GCC diagnostic push
# 180 "./src/basic/util.h"
;
# 180 "./src/basic/util.h"
...
# 284 "./src/basic/util.h"
ssize_t string_table_lookup(const char * const *table, size_t len, const char *key);
# 334 "./src/basic/util.h"
...
static inline _Bool __attribute__ ((pure)) in_charset(const char *s, const char* charset) {
        do { if ((__builtin_expect(!!(!(s)),0))) log_assert_failed("s", "./src/basic/util.h", 433, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(charset)),0))) log_assert_failed("charset", "./src/basic/util.h", 434, __PRETTY_FUNCTION__); } while (0);
...
static inline int negative_errno(void) {
        ...
        do { if (!(((__builtin_expect(!!((*__errno_location ()) > 0),1))) ? (1) : (log_assert_failed_return("(*__errno_location ()) > 0", "./src/basic/util.h", 657, __PRETTY_FUNCTION__), 0))) return (-22); } while (0);
...
static inline unsigned log2u_round_up(unsigned x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/basic/util.h", 704, __PRETTY_FUNCTION__); } while (0);
...
static inline void qsort_safe(void *base, size_t nmemb, size_t size, comparison_fn_t compar) {
        ...
        do { if ((__builtin_expect(!!(!(base)),0))) log_assert_failed("base", "./src/basic/util.h", 781, __PRETTY_FUNCTION__); } while (0);
...
static inline void *memmem_safe(const void *haystack, size_t haystacklen, const void *needle, size_t needlelen) {
        ...
        do { if ((__builtin_expect(!!(!(haystack)),0))) log_assert_failed("haystack", "./src/basic/util.h", 794, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(needle)),0))) log_assert_failed("needle", "./src/basic/util.h", 795, __PRETTY_FUNCTION__); } while (0);
...
# 1 "./src/libsystemd/sd-bus/bus-internal.h" 1
# 25 "./src/libsystemd/sd-bus/bus-internal.h"
...
# 26 "./src/libsystemd/sd-bus/bus-internal.h" 2
...
# 28 "./src/libsystemd/sd-bus/bus-internal.h" 2
# 1 "./src/basic/prioq.h" 1
# 26 "./src/basic/prioq.h"
...
void *prioq_peek(Prioq *q) __attribute__ ((pure));
void *prioq_pop(Prioq *q);

unsigned prioq_size(Prioq *q) __attribute__ ((pure));
_Bool prioq_isempty(Prioq *q) __attribute__ ((pure));
# 29 "./src/libsystemd/sd-bus/bus-internal.h" 2
# 1 "./src/basic/list.h" 1
# 30 "./src/libsystemd/sd-bus/bus-internal.h" 2

# 1 "./src/basic/refcnt.h" 1
# 26 "./src/basic/refcnt.h"
typedef struct {
        volatile unsigned _value;
} RefCount;
# 32 "./src/libsystemd/sd-bus/bus-internal.h" 2
...
# 33 "./src/libsystemd/sd-bus/bus-internal.h" 2



# 1 "./src/libsystemd/sd-bus/bus-match.h" 1
# 28 "./src/libsystemd/sd-bus/bus-match.h"
...
# 37 "./src/libsystemd/sd-bus/bus-internal.h" 2
# 1 "./src/libsystemd/sd-bus/bus-kernel.h" 1
# 59 "./src/libsystemd/sd-bus/bus-kernel.h"
struct memfd_cache {
        int fd;
        void *address;
        size_t mapped;
...
int bus_kernel_write_message(sd_bus *bus, sd_bus_message *m, _Bool hint_sync_call);
int bus_kernel_read_message(sd_bus *bus, _Bool hint_priority, int64_t priority);

int bus_kernel_open_bus_fd(const char *bus, char **path);

int bus_kernel_create_bus(const char *name, _Bool world, char **s);
...
# 38 "./src/libsystemd/sd-bus/bus-internal.h" 2
...
# 39 "./src/libsystemd/sd-bus/bus-internal.h" 2
...
# 63 "./src/libsystemd/sd-bus/bus-internal.h"
...
struct filter_callback {
        ...
        struct filter_callback * callbacks_next, * callbacks_prev;
};
...
struct node {
        ...
        struct node *parent;
        struct node *child;
        struct node * siblings_next, * siblings_prev;

        struct node_callback *callbacks;
        struct node_vtable *vtables;
        struct node_enumerator *enumerators;
        struct node_object_manager *object_managers;
};
...
struct node_callback {
        ...
        struct node_callback * callbacks_next, * callbacks_prev;
};
...
struct node_enumerator {
        ...
        struct node_enumerator * enumerators_next, * enumerators_prev;
};

struct node_object_manager {
        struct node *node;

        struct node_object_manager * object_managers_next, * object_managers_prev;
};
...
struct node_vtable {
        ...
        struct node_vtable * vtables_next, * vtables_prev;
};
...
struct sd_bus_slot {
        ...
        sd_bus_slot * slots_next, * slots_prev;
...
static inline _Bool BUS_IS_OPEN(enum bus_state state) {
...
struct sd_bus {
# 212 "./src/libsystemd/sd-bus/bus-internal.h"
        RefCount n_ref;
        ...
        _Bool ucred_valid:1;
        _Bool is_server:1;
        _Bool anonymous_auth:1;
        _Bool prefer_readv:1;
        _Bool prefer_writev:1;
        _Bool match_callbacks_modified:1;
        _Bool filter_callbacks_modified:1;
        _Bool nodes_modified:1;
        _Bool trusted:1;
        _Bool fake_creds_valid:1;
        _Bool fake_pids_valid:1;
        _Bool manual_peer_interface:1;
        _Bool is_system:1;
        _Bool is_user:1;
        _Bool allow_interactive_authorization:1;
        ...
        struct filter_callback *filter_callbacks;
        ...
        struct memfd_cache memfd_cache[32];
...
# 368 "./src/libsystemd/sd-bus/bus-internal.h"
_Bool interface_name_is_valid(const char *p) __attribute__ ((pure));
_Bool service_name_is_valid(const char *p) __attribute__ ((pure));
char* service_name_startswith(const char *a, const char *b);
_Bool member_name_is_valid(const char *p) __attribute__ ((pure));
_Bool object_path_is_valid(const char *p) __attribute__ ((pure));
char *object_path_startswith(const char *a, const char *b) __attribute__ ((pure));

_Bool namespace_complex_pattern(const char *pattern, const char *value) __attribute__ ((pure));
_Bool path_complex_pattern(const char *pattern, const char *value) __attribute__ ((pure));

_Bool namespace_simple_pattern(const char *pattern, const char *value) __attribute__ ((pure));
_Bool path_simple_pattern(const char *pattern, const char *value) __attribute__ ((pure));

int bus_message_type_from_string(const char *s, uint8_t *u) __attribute__ ((pure));
const char *bus_message_type_to_string(uint8_t u) __attribute__ ((pure));
...
_Bool bus_pid_changed(sd_bus *bus);

char *bus_address_escape(const char *v);
# 409 "./src/libsystemd/sd-bus/bus-internal.h"
...
static int manager_on_notify(sd_event_source *s, int fd, uint32_t revents, void *userdata) {
        ...
        if (msghdr.msg_flags & MSG_TRUNC) {
                ({ int _level = (4), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 611, __func__, "Got overly long notification datagram, ignoring.") : -abs(_e); });
                return 0;
        }

        if (!ucred || ucred->pid <= 0) {
                ({ int _level = (4), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 616, __func__, "Got notification datagram lacking credential information, ignoring.") : -abs(_e); });
                return 0;
        }
        ...
        if (!t) {
                ({ int _level = (4), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 625, __func__, "Got notification datagram from unexpected peer, ignoring.") : -abs(_e); });
                return 0;
        }
        ...
        *e = 0;
        ...
        if (r < 0 || percent > 100) {
                ({ int _level = (4), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 645, __func__, "Got invalid percent value, ignoring.") : -abs(_e); });
                return 0;
        }

        t->progress_percent = percent;

        ({ int _level = (7), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 651, __func__, "Got percentage from client: %u%%", percent) : -abs(_e); });
        return 0;
}
...
static int manager_new(Manager **ret) {
        ...
        do { if ((__builtin_expect(!!(!(ret)),0))) log_assert_failed("ret", "src/import/importd.c", 664, __PRETTY_FUNCTION__); } while (0);
...
static Transfer *manager_find(Manager *m, TransferType type, const char *dkr_index_url, const char *remote) {
        ...
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 707, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(type >= 0)),0))) log_assert_failed("type >= 0", "src/import/importd.c", 708, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(type < _TRANSFER_TYPE_MAX)),0))) log_assert_failed("type < _TRANSFER_TYPE_MAX", "src/import/importd.c", 709, __PRETTY_FUNCTION__); } while (0);
...
static int method_import_tar_or_raw(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 730, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 731, __PRETTY_FUNCTION__); } while (0);
...
static int method_export_tar_or_raw(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 794, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 795, __PRETTY_FUNCTION__); } while (0);
...
static int method_pull_dkr(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 940, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 941, __PRETTY_FUNCTION__); } while (0);
...
static int method_list_transfers(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 1037, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1038, __PRETTY_FUNCTION__); } while (0);
...
static int method_cancel(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 1074, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 1075, __PRETTY_FUNCTION__); } while (0);
...
static int method_cancel_transfer(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 1103, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1104, __PRETTY_FUNCTION__); } while (0);
...
static int property_get_progress(
        ...
        do { if ((__builtin_expect(!!(!(bus)),0))) log_assert_failed("bus", "src/import/importd.c", 1147, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(reply)),0))) log_assert_failed("reply", "src/import/importd.c", 1148, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 1149, __PRETTY_FUNCTION__); } while (0);

        return sd_bus_message_append(reply, "d", (double) t->progress_percent / 100.0);
}

static int property_get_type(sd_bus *bus, const char *path, const char *interface, const char *property, sd_bus_message *reply, void *userdata, sd_bus_error *error) { const char *value; TransferType *field = userdata; int r; do { if ((__builtin_expect(!!(!(bus)),0))) log_assert_failed("bus", "src/import/importd.c", 1154, __PRETTY_FUNCTION__); } while (0); do { if ((__builtin_expect(!!(!(reply)),0))) log_assert_failed("reply", "src/import/importd.c", 1154, __PRETTY_FUNCTION__); } while (0); do { if ((__builtin_expect(!!(!(field)),0))) log_assert_failed("field", "src/import/importd.c", 1154, __PRETTY_FUNCTION__); } while (0); value = strempty( transfer_type_to_string(*field)); r = sd_bus_message_append_basic(reply, 's', value); if (r < 0) return r; return 1; } struct __useless_struct_to_allow_trailing_semicolon__;
...
static int transfer_object_find(sd_bus *bus, const char *path, const char *interface, void *userdata, void **found, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(bus)),0))) log_assert_failed("bus", "src/import/importd.c", 1193, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(path)),0))) log_assert_failed("path", "src/import/importd.c", 1194, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(interface)),0))) log_assert_failed("interface", "src/import/importd.c", 1195, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(found)),0))) log_assert_failed("found", "src/import/importd.c", 1196, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1197, __PRETTY_FUNCTION__); } while (0);
...
static int manager_add_bus_objects(Manager *m) {
        ...
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1244, __PRETTY_FUNCTION__); } while (0);

        r = sd_bus_add_object_vtable(m->bus, ((void*)0), "/org/freedesktop/import1", "org.freedesktop.import1.Manager", manager_vtable, m);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1248, __func__, "Failed to register object: %m") : -abs(_e); });
        ...
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1256, __func__, "Failed to add transfer enumerator: %m") : -abs(_e); });

        r = sd_bus_request_name(m->bus, "org.freedesktop.import1", 0);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1260, __func__, "Failed to register name: %m") : -abs(_e); });

        r = sd_bus_attach_event(m->bus, m->event, 0);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1264, __func__, "Failed to attach bus to event loop: %m") : -abs(_e); });
...
static int manager_run(Manager *m) {
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1276, __PRETTY_FUNCTION__); } while (0);
...
int main(int argc, char *argv[]) {
        ...
        if (argc != 1) {
                ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1298, __func__, "This program takes no arguments.") : -abs(_e); });
                r = -22;
                goto finish;
        }

        do { if ((__builtin_expect(!!(!(sigprocmask_many(0, ((void*)0), 17, -1) >= 0)),0))) log_assert_failed("sigprocmask_many(SIG_BLOCK, NULL, SIGCHLD, -1) >= 0", "src/import/importd.c", 1303, __PRETTY_FUNCTION__); } while (0);

        r = manager_new(&m);
        if (r < 0) {
                ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1307, __func__, "Failed to allocate manager object: %m") : -abs(_e); });
                goto finish;
        }
        ...
        r = manager_run(m);
        if (r < 0) {
                ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1317, __func__, "Failed to run event loop: %m") : -abs(_e); });
                goto finish;
        }
