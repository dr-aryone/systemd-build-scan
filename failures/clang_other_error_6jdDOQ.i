...
# 22 "/usr/include/netinet/ether.h" 3 4
...
# 23 "/usr/include/netinet/ether.h" 2 3 4


# 1 "/usr/include/netinet/if_ether.h" 1 3 4
# 22 "/usr/include/netinet/if_ether.h" 3 4
...
# 23 "/usr/include/netinet/if_ether.h" 2 3 4
...
# 28 "/usr/include/net/if_arp.h" 3 4
...
# 29 "/usr/include/net/if_arp.h" 2 3 4
...
# 22 "src/network/networkd-ndisc.c" 2
...
# 117 "/usr/include/linux/if.h" 3 4
enum {
 IF_OPER_UNKNOWN,
 IF_OPER_NOTPRESENT,
 IF_OPER_DOWN,
...
# 177 "/usr/include/linux/if.h" 3 4
struct ifreq {
...
# 226 "/usr/include/linux/if.h" 3 4
struct ifconf {
 int ifc_len;
 union {
  char *ifcu_buf;
...
# 24 "src/network/networkd-ndisc.c" 2

# 1 "./src/systemd/sd-ndisc.h" 1
# 26 "./src/systemd/sd-ndisc.h"
...
static inline size_t FAMILY_ADDRESS_SIZE(int family) {
        do { if ((__builtin_expect(!!(!(family == 2 || family == 10)),0))) log_assert_failed("family == AF_INET || family == AF_INET6", "./src/basic/in-addr-util.h", 55, __PRETTY_FUNCTION__); } while (0);
...
# 155 "./src/network/networkd-netdev.h"
...
# 35 "./src/network/networkd-network.h" 2
...
# 28 "src/network/networkd-ndisc.c" 2

static int ndisc_netlink_handler(sd_netlink *rtnl, sd_netlink_message *m, void *userdata) {
        __attribute__((cleanup(link_unrefp))) Link *link = userdata;
        int r;

        do { if ((__builtin_expect(!!(!(link)),0))) log_assert_failed("link", "src/network/networkd-ndisc.c", 33, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(link->ndisc_messages > 0)),0))) log_assert_failed("link->ndisc_messages > 0", "src/network/networkd-ndisc.c", 34, __PRETTY_FUNCTION__); } while (0);

        link->ndisc_messages--;

        r = sd_netlink_message_get_errno(m);
        if (r < 0 && r != -17) {
                ({ Link *_l = (link); _l ? log_object_internal(3, r, "src/network/networkd-ndisc.c", 40, __func__, "INTERFACE=", _l->ifname, "Could not set NDisc route or address: %m") : log_internal(3, r, "src/network/networkd-ndisc.c", 40, __func__, "Could not set NDisc route or address: %m"); });
...
static void ndisc_prefix_autonomous_handler(sd_ndisc *nd, const struct in6_addr *prefix, unsigned prefixlen,
        ...
        do { if ((__builtin_expect(!!(!(nd)),0))) log_assert_failed("nd", "src/network/networkd-ndisc.c", 59, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(link)),0))) log_assert_failed("link", "src/network/networkd-ndisc.c", 60, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(link->network)),0))) log_assert_failed("link->network", "src/network/networkd-ndisc.c", 61, __PRETTY_FUNCTION__); } while (0);
        ...
        if (r < 0) {
                ({ Link *_l = (link); _l ? log_object_internal(3, r, "src/network/networkd-ndisc.c", 68, __func__, "INTERFACE=", _l->ifname, "Could not allocate address: %m") : log_internal(3, r, "src/network/networkd-ndisc.c", 68, __func__, "Could not allocate address: %m"); });
                return;
        }

        do { if ((__builtin_expect(!!(!(sd_event_now(link->manager->event, clock_boottime_or_monotonic(), &time_now) >= 0)),0))) log_assert_failed("sd_event_now(link->manager->event, clock_boottime_or_monotonic(), &time_now) >= 0", "src/network/networkd-ndisc.c", 72, __PRETTY_FUNCTION__); } while (0);
        ...
        if (r < 0) {
                ({ Link *_l = (link); _l ? log_object_internal(4, r, "src/network/networkd-ndisc.c", 97, __func__, "INTERFACE=", _l->ifname, "Could not set SLAAC address: %m") : log_internal(4, r, "src/network/networkd-ndisc.c", 97, __func__, "Could not set SLAAC address: %m"); });
                link_enter_failed(link);
                return;
        }
...
static void ndisc_prefix_onlink_handler(sd_ndisc *nd, const struct in6_addr *prefix, unsigned prefixlen, unsigned lifetime, void *userdata) {
        ...
        do { if ((__builtin_expect(!!(!(nd)),0))) log_assert_failed("nd", "src/network/networkd-ndisc.c", 111, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(link)),0))) log_assert_failed("link", "src/network/networkd-ndisc.c", 112, __PRETTY_FUNCTION__); } while (0);
        ...
        r = route_new(&route);
        if (r < 0) {
                ({ Link *_l = (link); _l ? log_object_internal(3, r, "src/network/networkd-ndisc.c", 119, __func__, "INTERFACE=", _l->ifname, "Could not allocate route: %m") : log_internal(3, r, "src/network/networkd-ndisc.c", 119, __func__, "Could not allocate route: %m"); });
                return;
        }

        do { if ((__builtin_expect(!!(!(sd_event_now(link->manager->event, clock_boottime_or_monotonic(), &time_now) >= 0)),0))) log_assert_failed("sd_event_now(link->manager->event, clock_boottime_or_monotonic(), &time_now) >= 0", "src/network/networkd-ndisc.c", 123, __PRETTY_FUNCTION__); } while (0);
        ...
        if (r < 0) {
                ({ Link *_l = (link); _l ? log_object_internal(4, r, "src/network/networkd-ndisc.c", 135, __func__, "INTERFACE=", _l->ifname, "Could not set prefix route: %m") : log_internal(4, r, "src/network/networkd-ndisc.c", 135, __func__, "Could not set prefix route: %m"); });
                link_enter_failed(link);
                return;
        }
...
static void ndisc_router_handler(sd_ndisc *nd, uint8_t flags, const struct in6_addr *gateway, unsigned lifetime, int pref, void *userdata) {
        ...
        do { if ((__builtin_expect(!!(!(link)),0))) log_assert_failed("link", "src/network/networkd-ndisc.c", 149, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(link->network)),0))) log_assert_failed("link->network", "src/network/networkd-ndisc.c", 150, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(link->manager)),0))) log_assert_failed("link->manager", "src/network/networkd-ndisc.c", 151, __PRETTY_FUNCTION__); } while (0);
        ...
        if (flags & (0x80 | 0x40)) {
                ...
                if (r < 0 && r != -16)
                        return ({ Link *_l = (link); _l ? log_object_internal(4, r, "src/network/networkd-ndisc.c", 162, __func__, "INTERFACE=", _l->ifname, "Could not set IPv6LL address in DHCP client: %m") : log_internal(4, r, "src/network/networkd-ndisc.c", 162, __func__, "Could not set IPv6LL address in DHCP client: %m"); });

                r = sd_dhcp6_client_start(link->dhcp6_client);
                if (r < 0 && r != -16)
                        ({ Link *_l = (link); _l ? log_object_internal(4, r, "src/network/networkd-ndisc.c", 166, __func__, "INTERFACE=", _l->ifname, "Starting DHCPv6 client on NDisc request failed: %m") : log_internal(4, r, "src/network/networkd-ndisc.c", 166, __func__, "Starting DHCPv6 client on NDisc request failed: %m"); });
        }
        ...
        r = route_new(&route);
        if (r < 0) {
                ({ Link *_l = (link); _l ? log_object_internal(3, r, "src/network/networkd-ndisc.c", 174, __func__, "INTERFACE=", _l->ifname, "Could not allocate route: %m") : log_internal(3, r, "src/network/networkd-ndisc.c", 174, __func__, "Could not allocate route: %m"); });
                return;
        }

        do { if ((__builtin_expect(!!(!(sd_event_now(link->manager->event, clock_boottime_or_monotonic(), &time_now) >= 0)),0))) log_assert_failed("sd_event_now(link->manager->event, clock_boottime_or_monotonic(), &time_now) >= 0", "src/network/networkd-ndisc.c", 178, __PRETTY_FUNCTION__); } while (0);
        ...
        r = route_configure(route, link, ndisc_netlink_handler);
        if (r < 0) {
                ({ Link *_l = (link); _l ? log_object_internal(4, r, "src/network/networkd-ndisc.c", 189, __func__, "INTERFACE=", _l->ifname, "Could not set default route: %m") : log_internal(4, r, "src/network/networkd-ndisc.c", 189, __func__, "Could not set default route: %m"); });
                link_enter_failed(link);
                return;
        }
...
static void ndisc_handler(sd_ndisc *nd, int event, void *userdata) {
        ...
        do { if ((__builtin_expect(!!(!(link)),0))) log_assert_failed("link", "src/network/networkd-ndisc.c", 201, __PRETTY_FUNCTION__); } while (0);
        ...
        case SD_NDISC_EVENT_TIMEOUT:
                ...
                r = sd_dhcp6_client_set_local_address(link->dhcp6_client, &link->ipv6ll_address);
                if (r < 0 && r != -16)
                        return ({ Link *_l = (link); _l ? log_object_internal(4, r, "src/network/networkd-ndisc.c", 212, __func__, "INTERFACE=", _l->ifname, "Could not set IPv6LL address in DHCP client: %m") : log_internal(4, r, "src/network/networkd-ndisc.c", 212, __func__, "Could not set IPv6LL address in DHCP client: %m"); });

                r = sd_dhcp6_client_start(link->dhcp6_client);
                if (r < 0 && r != -16)
                        ({ Link *_l = (link); _l ? log_object_internal(4, r, "src/network/networkd-ndisc.c", 216, __func__, "INTERFACE=", _l->ifname, "Starting DHCPv6 client after NDisc timeout failed: %m") : log_internal(4, r, "src/network/networkd-ndisc.c", 216, __func__, "Starting DHCPv6 client after NDisc timeout failed: %m"); });
        ...
        case SD_NDISC_EVENT_STOP:
                break;
        default:
                ({ Link *_l = (link); _l ? log_object_internal(4, 0, "src/network/networkd-ndisc.c", 225, __func__, "INTERFACE=", _l->ifname, "IPv6 Neighbor Discovery unknown event: %d", event) : log_internal(4, 0, "src/network/networkd-ndisc.c", 225, __func__, "IPv6 Neighbor Discovery unknown event: %d", event); });
        }
}
...
int ndisc_configure(Link *link) {
        ...
        do { if (!(((__builtin_expect(!!(link),1))) ? (1) : (log_assert_failed_return("link", "src/network/networkd-ndisc.c", 232, __PRETTY_FUNCTION__), 0))) return (-22); } while (0);

        r = sd_ndisc_new(&link->ndisc_router_discovery);
        if (r < 0)
                return r;

        r = sd_ndisc_attach_event(link->ndisc_router_discovery, ((void*)0), 0);
        if (r < 0)
                return r;
