...
# 182 "./src/basic/util.h"
static inline int safe_atolu(const char *s, unsigned long *ret_u) {
#pragma GCC diagnostic push
# 183 "./src/basic/util.h"
;
# 183 "./src/basic/util.h"
...
# 287 "./src/basic/util.h"
ssize_t string_table_lookup(const char * const *table, size_t len, const char *key);
# 337 "./src/basic/util.h"
...
static inline _Bool __attribute__ ((pure)) in_charset(const char *s, const char* charset) {
        do { if ((__builtin_expect(!!(!(s)),0))) log_assert_failed("s", "./src/basic/util.h", 437, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(charset)),0))) log_assert_failed("charset", "./src/basic/util.h", 438, __PRETTY_FUNCTION__); } while (0);
...
static inline int negative_errno(void) {
        ...
        do { if (!(((__builtin_expect(!!((*__errno_location ()) > 0),1))) ? (1) : (log_assert_failed_return("(*__errno_location ()) > 0", "./src/basic/util.h", 662, __PRETTY_FUNCTION__), 0))) return (-22); } while (0);
...
static inline unsigned log2i(int x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/basic/util.h", 697, __PRETTY_FUNCTION__); } while (0);
...
# 730 "./src/basic/util.h"
int unlink_noerrno(const char *path);
# 772 "./src/basic/util.h"
...
static inline void qsort_safe(void *base, size_t nmemb, size_t size, comparison_fn_t compar) {
        ...
        do { if ((__builtin_expect(!!(!(base)),0))) log_assert_failed("base", "./src/basic/util.h", 786, __PRETTY_FUNCTION__); } while (0);
...
static inline void *memmem_safe(const void *haystack, size_t haystacklen, const void *needle, size_t needlelen) {
        ...
        do { if ((__builtin_expect(!!(!(haystack)),0))) log_assert_failed("haystack", "./src/basic/util.h", 799, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(needle)),0))) log_assert_failed("needle", "./src/basic/util.h", 800, __PRETTY_FUNCTION__); } while (0);
...
static int method_export_tar_or_raw(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 796, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 797, __PRETTY_FUNCTION__); } while (0);
...
static int method_pull_tar_or_raw(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 862, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 863, __PRETTY_FUNCTION__); } while (0);
...
static int method_pull_dkr(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 944, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 945, __PRETTY_FUNCTION__); } while (0);
...
static int method_list_transfers(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 1042, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1043, __PRETTY_FUNCTION__); } while (0);
...
static int method_cancel(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 1079, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(t)),0))) log_assert_failed("t", "src/import/importd.c", 1080, __PRETTY_FUNCTION__); } while (0);
...
static int method_cancel_transfer(sd_bus_message *msg, void *userdata, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(msg)),0))) log_assert_failed("msg", "src/import/importd.c", 1109, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1110, __PRETTY_FUNCTION__); } while (0);
...
static int transfer_object_find(sd_bus *bus, const char *path, const char *interface, void *userdata, void **found, sd_bus_error *error) {
        ...
        do { if ((__builtin_expect(!!(!(bus)),0))) log_assert_failed("bus", "src/import/importd.c", 1200, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(path)),0))) log_assert_failed("path", "src/import/importd.c", 1201, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(interface)),0))) log_assert_failed("interface", "src/import/importd.c", 1202, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(found)),0))) log_assert_failed("found", "src/import/importd.c", 1203, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1204, __PRETTY_FUNCTION__); } while (0);
...
static int manager_add_bus_objects(Manager *m) {
        ...
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1251, __PRETTY_FUNCTION__); } while (0);

        r = sd_bus_add_object_vtable(m->bus, ((void*)0), "/org/freedesktop/import1", "org.freedesktop.import1.Manager", manager_vtable, m);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1255, __func__, "Failed to register object: %m") : -abs(_e); });
        ...
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1259, __func__, "Failed to register object: %m") : -abs(_e); });

        r = sd_bus_add_node_enumerator(m->bus, ((void*)0), "/org/freedesktop/import1/transfer", transfer_node_enumerator, m);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1263, __func__, "Failed to add transfer enumerator: %m") : -abs(_e); });

        r = sd_bus_request_name(m->bus, "org.freedesktop.import1", 0);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1267, __func__, "Failed to register name: %m") : -abs(_e); });

        r = sd_bus_attach_event(m->bus, m->event, 0);
        if (r < 0)
                return ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1271, __func__, "Failed to attach bus to event loop: %m") : -abs(_e); });
...
static int manager_run(Manager *m) {
        do { if ((__builtin_expect(!!(!(m)),0))) log_assert_failed("m", "src/import/importd.c", 1283, __PRETTY_FUNCTION__); } while (0);
...
int main(int argc, char *argv[]) {
        ...
        if (argc != 1) {
                ({ int _level = (3), _e = (0); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1305, __func__, "This program takes no arguments.") : -abs(_e); });
                r = -22;
                goto finish;
        }

        do { if ((__builtin_expect(!!(!(sigprocmask_many(0, ((void*)0), 17, -1) >= 0)),0))) log_assert_failed("sigprocmask_many(SIG_BLOCK, NULL, SIGCHLD, -1) >= 0", "src/import/importd.c", 1310, __PRETTY_FUNCTION__); } while (0);

        r = manager_new(&m);
        if (r < 0) {
                ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1314, __func__, "Failed to allocate manager object: %m") : -abs(_e); });
                goto finish;
        }
        ...
        r = manager_run(m);
        if (r < 0) {
                ({ int _level = (3), _e = (r); (log_get_max_level() >= ((_level) & 0x07)) ? log_internal(_level, _e, "src/import/importd.c", 1324, __func__, "Failed to run event loop: %m") : -abs(_e); });
                goto finish;
        }
