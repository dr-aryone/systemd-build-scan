...
static inline _Bool __attribute__ ((pure)) in_charset(const char *s, const char* charset) {
        do { if ((__builtin_expect(!!(!(s)),0))) log_assert_failed("s", "./src/basic/util.h", 442, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(charset)),0))) log_assert_failed("charset", "./src/basic/util.h", 443, __PRETTY_FUNCTION__); } while (0);
...
static inline int negative_errno(void) {
        ...
        do { if (!(((__builtin_expect(!!((*__errno_location ()) > 0),1))) ? (1) : (log_assert_failed_return("errno > 0", "./src/basic/util.h", 670, __PRETTY_FUNCTION__), 0))) return (-22); } while (0);
...
static inline unsigned log2i(int x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/basic/util.h", 705, __PRETTY_FUNCTION__); } while (0);

        return 4 * 8 - __builtin_clz(x) - 1;
}

static inline unsigned log2u(unsigned x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/basic/util.h", 711, __PRETTY_FUNCTION__); } while (0);

        return sizeof(unsigned) * 8 - __builtin_clz(x) - 1;
}

static inline unsigned log2u_round_up(unsigned x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/basic/util.h", 717, __PRETTY_FUNCTION__); } while (0);
...
static inline void qsort_safe(void *base, size_t nmemb, size_t size, comparison_fn_t compar) {
        ...
        do { if ((__builtin_expect(!!(!(base)),0))) log_assert_failed("base", "./src/basic/util.h", 794, __PRETTY_FUNCTION__); } while (0);
...
static inline void *memmem_safe(const void *haystack, size_t haystacklen, const void *needle, size_t needlelen) {
        ...
        do { if ((__builtin_expect(!!(!(haystack)),0))) log_assert_failed("haystack", "./src/basic/util.h", 807, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(needle)),0))) log_assert_failed("needle", "./src/basic/util.h", 808, __PRETTY_FUNCTION__); } while (0);
...
static int transfer_start(Transfer *t) {
        ...
        if (t->pid == 0) {
                ...
                if (({ static const typeof(TRANSFER_IMPORT_TAR) _array[] = { (TRANSFER_IMPORT_TAR), TRANSFER_IMPORT_RAW }; const typeof(TRANSFER_IMPORT_TAR) _x = (t->type); unsigned _i; _Bool _found = 0; for (_i = 0; _i < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_array), typeof(&*(_array))), sizeof(_array)/sizeof((_array)[0]), (void)0)); _i++) if (_array[_i] == _x) { _found = 1; break; } _found; }))
                        cmd[k++] = "/usr/lib/systemd/systemd-import";
                else if (({ static const typeof(TRANSFER_EXPORT_TAR) _array[] = { (TRANSFER_EXPORT_TAR), TRANSFER_EXPORT_RAW }; const typeof(TRANSFER_EXPORT_TAR) _x = (t->type); unsigned _i; _Bool _found = 0; for (_i = 0; _i < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_array), typeof(&*(_array))), sizeof(_array)/sizeof((_array)[0]), (void)0)); _i++) if (_array[_i] == _x) { _found = 1; break; } _found; }))
                        cmd[k++] = "/usr/lib/systemd/systemd-export";
                else
                        cmd[k++] = SYSTEMD_PULL_PATH;

                if (({ static const typeof(TRANSFER_IMPORT_TAR) _array[] = { (TRANSFER_IMPORT_TAR), TRANSFER_EXPORT_TAR, TRANSFER_PULL_TAR }; const typeof(TRANSFER_IMPORT_TAR) _x = (t->type); unsigned _i; _Bool _found = 0; for (_i = 0; _i < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_array), typeof(&*(_array))), sizeof(_array)/sizeof((_array)[0]), (void)0)); _i++) if (_array[_i] == _x) { _found = 1; break; } _found; }))
                        cmd[k++] = "tar";
                else if (({ static const typeof(TRANSFER_IMPORT_RAW) _array[] = { (TRANSFER_IMPORT_RAW), TRANSFER_EXPORT_RAW, TRANSFER_PULL_RAW }; const typeof(TRANSFER_IMPORT_RAW) _x = (t->type); unsigned _i; _Bool _found = 0; for (_i = 0; _i < __extension__ (__builtin_choose_expr( !__builtin_types_compatible_p(typeof(_array), typeof(&*(_array))), sizeof(_array)/sizeof((_array)[0]), (void)0)); _i++) if (_array[_i] == _x) { _found = 1; break; } _found; }))
                        cmd[k++] = "raw";
                else
                        cmd[k++] = "dkr";
