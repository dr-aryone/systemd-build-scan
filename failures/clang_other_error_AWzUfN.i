...
# 1 "./src/shared/util.h" 1
# 24 "./src/shared/util.h"
...
extern int fstatfs64 (int __fildes, struct statfs64 *__buf)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (2)));
# 44 "./src/shared/util.h" 2

# 1 "./src/shared/macro.h" 1
# 24 "./src/shared/macro.h"
...
# 26 "./src/shared/macro.h" 2
# 106 "./src/shared/macro.h"
...
# 473 "./src/shared/macro.h"
# 1 "./src/shared/log.h" 1
# 27 "./src/shared/log.h"
...
# 474 "./src/shared/macro.h" 2
# 46 "./src/shared/util.h" 2
# 1 "./src/shared/missing.h" 1
# 26 "./src/shared/missing.h"
...
# 28 "./src/shared/missing.h" 2



# 1 "/usr/include/errno.h" 1 3 4
# 32 "./src/shared/missing.h" 2
# 1 "/usr/include/linux/oom.h" 1 3 4
# 33 "./src/shared/missing.h" 2
...
# 47 "./src/shared/util.h" 2
# 1 "./src/shared/time-util.h" 1
# 27 "./src/shared/time-util.h"
...
# 48 "./src/shared/util.h" 2
# 1 "./src/shared/formats-util.h" 1
# 49 "./src/shared/util.h" 2
# 65 "./src/shared/util.h"
...
# 173 "./src/shared/util.h"
static inline int safe_atolu(const char *s, unsigned long *ret_u) {
#pragma GCC diagnostic push
# 174 "./src/shared/util.h"
;
# 174 "./src/shared/util.h"
...
# 274 "./src/shared/util.h"
ssize_t string_table_lookup(const char * const *table, size_t len, const char *key);
# 324 "./src/shared/util.h"
...
static inline _Bool __attribute__ ((pure)) in_charset(const char *s, const char* charset) {
        do { if ((__builtin_expect(!!(!(s)),0))) log_assert_failed("s", "./src/shared/util.h", 423, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(charset)),0))) log_assert_failed("charset", "./src/shared/util.h", 424, __PRETTY_FUNCTION__); } while (0);
...
static inline int negative_errno(void) {
        ...
        do { if ((__builtin_expect(!!(!((*__errno_location ()) > 0)),0))) { log_assert_failed_return("errno > 0", "./src/shared/util.h", 641, __PRETTY_FUNCTION__); return (-22); } } while (0);
...
static inline unsigned log2i(int x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/shared/util.h", 676, __PRETTY_FUNCTION__); } while (0);

        return 4 * 8 - __builtin_clz(x) - 1;
}

static inline unsigned log2u(unsigned x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/shared/util.h", 682, __PRETTY_FUNCTION__); } while (0);

        return sizeof(unsigned) * 8 - __builtin_clz(x) - 1;
}

static inline unsigned log2u_round_up(unsigned x) {
        do { if ((__builtin_expect(!!(!(x > 0)),0))) log_assert_failed("x > 0", "./src/shared/util.h", 688, __PRETTY_FUNCTION__); } while (0);
...
static inline void qsort_safe(void *base, size_t nmemb, size_t size, comparison_fn_t compar) {
        ...
        do { if ((__builtin_expect(!!(!(base)),0))) log_assert_failed("base", "./src/shared/util.h", 765, __PRETTY_FUNCTION__); } while (0);
...
static inline void *memmem_safe(const void *haystack, size_t haystacklen, const void *needle, size_t needlelen) {
        ...
        do { if ((__builtin_expect(!!(!(haystack)),0))) log_assert_failed("haystack", "./src/shared/util.h", 778, __PRETTY_FUNCTION__); } while (0);
        do { if ((__builtin_expect(!!(!(needle)),0))) log_assert_failed("needle", "./src/shared/util.h", 779, __PRETTY_FUNCTION__); } while (0);
...
# 97 "./src/shared/strv.h"
char **strv_sort(char **l);
void strv_print(char **l);
# 147 "./src/shared/strv.h"
...
static inline _Bool strv_fnmatch_or_empty(char* const* patterns, const char *s, int flags) {
        do { if ((__builtin_expect(!!(!(s)),0))) log_assert_failed("s", "./src/shared/strv.h", 152, __PRETTY_FUNCTION__); } while (0);
        return strv_isempty(patterns) ||
               strv_fnmatch(patterns, s, flags);
}
# 27 "src/import/importd.c" 2
# 1 "./src/libsystemd/sd-bus/bus-util.h" 1
# 26 "./src/libsystemd/sd-bus/bus-util.h"
# 1 "./src/shared/hashmap.h" 1
# 47 "./src/shared/hashmap.h"
...
static inline void *hashmap_iterate(Hashmap *h, Iterator *i, const void **key) {
        return internal_hashmap_iterate(__builtin_choose_expr((__builtin_types_compatible_p(typeof(h), HashmapBase*) || __builtin_types_compatible_p(typeof(h), Hashmap*) || __builtin_types_compatible_p(typeof(h), OrderedHashmap*) || __builtin_types_compatible_p(typeof(h), Set*)), (HashmapBase*)(h), (void)0), i, key);
}
...
# 27 "./src/libsystemd/sd-bus/bus-util.h" 2
...
# 1 "./src/shared/unit-name.h" 1
# 30 "./src/shared/unit-name.h"
...
# 28 "./src/libsystemd/sd-bus/bus-util.h" 2
...
#pragma GCC diagnostic push
# 82 "./src/libsystemd/sd-bus/bus-util.h"
;
# 82 "./src/libsystemd/sd-bus/bus-util.h"
#pragma GCC diagnostic ignored "-Wdeclaration-after-statement"
# 82 "./src/libsystemd/sd-bus/bus-util.h"
...
#pragma GCC diagnostic push
# 85 "./src/libsystemd/sd-bus/bus-util.h"
;
# 85 "./src/libsystemd/sd-bus/bus-util.h"
#pragma GCC diagnostic ignored "-Wdeclaration-after-statement"
# 85 "./src/libsystemd/sd-bus/bus-util.h"
...
# 85 "./src/libsystemd/sd-bus/bus-util.h"
;
# 107 "./src/libsystemd/sd-bus/bus-util.h"
#pragma GCC diagnostic push
# 107 "./src/libsystemd/sd-bus/bus-util.h"
;
# 107 "./src/libsystemd/sd-bus/bus-util.h"
...
#pragma GCC diagnostic push
# 110 "./src/libsystemd/sd-bus/bus-util.h"
;
# 110 "./src/libsystemd/sd-bus/bus-util.h"
#pragma GCC diagnostic ignored "-Wdeclaration-after-statement"
# 110 "./src/libsystemd/sd-bus/bus-util.h"
...
#pragma GCC diagnostic push
# 113 "./src/libsystemd/sd-bus/bus-util.h"
;
# 113 "./src/libsystemd/sd-bus/bus-util.h"
#pragma GCC diagnostic ignored "-Wdeclaration-after-statement"
# 113 "./src/libsystemd/sd-bus/bus-util.h"
...
#pragma GCC diagnostic push
# 116 "./src/libsystemd/sd-bus/bus-util.h"
;
# 116 "./src/libsystemd/sd-bus/bus-util.h"
#pragma GCC diagnostic ignored "-Wdeclaration-after-statement"
# 116 "./src/libsystemd/sd-bus/bus-util.h"
...
# 191 "./src/libsystemd/sd-bus/bus-util.h"
...
# 1 "./src/shared/socket-util.h" 1
# 25 "./src/shared/socket-util.h"
...
# 1 "./src/shared/mkdir.h" 1
# 27 "./src/shared/mkdir.h"
...
# 1 "./src/shared/path-util.h" 1
# 38 "./src/shared/path-util.h"
...
# 1 "./src/shared/process-util.h" 1
# 44 "./src/shared/process-util.h"
...
# 1 "./src/shared/signal-util.h" 1
# 28 "./src/shared/signal-util.h"
...
static int manager_on_notify(sd_event_source *s, int fd, uint32_t revents, void *userdata) {
        ...
        for ((i) = ((Iterator) { .idx = ((2147483647 *2U +1U) - 1), .next_key = ((void*)0) }), (t) = hashmap_iterate((m->transfers), &(i), ((void*)0)); (t); (t) = hashmap_iterate((m->transfers), &(i), ((void*)0)))
                if (ucred->pid == t->pid)
                        break;
...
int main(int argc, char *argv[]) {
        ...
        do { if ((__builtin_expect(!!(!(sigprocmask_many(0, 17, -1) >= 0)),0))) log_assert_failed("sigprocmask_many(SIG_BLOCK, SIGCHLD, -1) >= 0", "src/import/importd.c", 1304, __PRETTY_FUNCTION__); } while (0);
